...
var len__4789__auto___30123 = arguments.length;
var i__4790__auto___30124 = (0);
while(true){
if((i__4790__auto___30124 < len__4789__auto___30123)){
args__4795__auto__.push((arguments[i__4790__auto___30124]));

var G__30125 = (i__4790__auto___30124 + (1));
i__4790__auto___30124 = G__30125;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30077){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30094_SHARP_){
return (!((cljs.core.meta(p1__30094_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30102__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30110){var _e__29711__auto__ = e30110;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e30114){var _e__29711__auto__ = e30114;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30116 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30117 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30117);

try{var map__30118 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30118__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30116);
}});
...
var temp__5733__auto___30139 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___30139)){
var managed_print_level_30140 = temp__5733__auto___30139;
var _STAR_print_level_STAR__orig_val__30121_30141 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30122_30142 = managed_print_level_30140;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30122_30142);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30120_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30120_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30121_30141);
}} else {
job_fn();
}
