...
var G__30075 = devtools.prefs.pref(v);
v = G__30075;
continue;
} else {
return v;
...
}catch (e30049){var _e__29711__auto__ = e30049;
return false;
}})();
...
}catch (e30059){var _e__29711__auto__ = e30059;
return false;
}})();
...
}catch (e30062){var _e__29711__auto__ = e30062;
return false;
}}
}
});
...
var vec__30066 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30066,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30066,(1),null);
...
return cljs.core.some((function (p1__30069_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__30069_SHARP_);
}),template);
});
