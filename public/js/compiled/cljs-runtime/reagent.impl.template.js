...
var G__32319 = o;
goog.object.set(G__32319,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__32346__delegate = function (args){
...
while (G__32347__i < G__32347__a.length) {G__32347__a[G__32347__i] = arguments[G__32347__i + 0]; ++G__32347__i;}
  args = new cljs.core.IndexedSeq(G__32347__a,0,null);
} 
...
var G__32323 = o;
goog.object.set(G__32323,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__32350__i < G__32350__a.length) {G__32350__a[G__32350__i] = arguments[G__32350__i + 0]; ++G__32350__i;}
  args = new cljs.core.IndexedSeq(G__32350__a,0,null);
} 
...
var G__32324 = props;
var G__32324__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32324,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__32324);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32324__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__32324__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__32325 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32325,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__32325;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__32326){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32327__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__32329_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__32329_SHARP_);
}));
} else {
return null;
}
...
var vec__32331 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32331,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32331,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32331,(2),null);
...
var temp__5739__auto___32355 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___32355 == null)){
} else {
var key_32356 = temp__5739__auto___32355;
(jsprops.key = key_32356);
}
...
var temp__5739__auto___32359 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___32359 == null)){
} else {
var key_32360 = temp__5739__auto___32359;
(jsprops.key = key_32360);
}
...
var G__32335 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__32335) : reagent.impl.template.as_element.call(null,G__32335));
} else {
var temp__5739__auto___32361 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___32361 == null)){
} else {
var key_32362 = temp__5739__auto___32361;
(jsprops.key = key_32362);
}
...
var G__32337 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__32337)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__32337)){
return x;
} else {
...
var len__4789__auto___32363 = arguments.length;
var i__4790__auto___32364 = (0);
while(true){
if((i__4790__auto___32364 < len__4789__auto___32363)){
args__4795__auto__.push((arguments[i__4790__auto___32364]));

var G__32365 = (i__4790__auto___32364 + (1));
i__4790__auto___32364 = G__32365;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq32338){
var G__32339 = cljs.core.first(seq32338);
var seq32338__$1 = cljs.core.next(seq32338);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32339,seq32338__$1);
}));
...
break;
default:
var G__32367 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__32367;
continue;
...
var ctx = ({});
var vec__32342 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32342,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32342,(1),null);
...
var G__32345 = (cljs.core.count(argv) - first_child);
switch (G__32345) {
case (0):
